...
CREATE TABLE "contact_info" (
    "id" TEXT NOT NULL,
    "companyName" TEXT NOT NULL DEFAULT 'GreenPark Peyzaj',
...
-- AddForeignKey
ALTER TABLE "images" ADD CONSTRAINT "images_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "services"("id") ON DELETE CASCADE ON UPDATE CASCADE;
